...
export const courses: Course[] = [
  {
    ...
    modules: [
      { title: "뇌건강 기초 이론", lessons: ["뇌의 구조와 기능", "노화와 인지기능", "치매의 이해"], duration: "3시간" },
      { title: "인지 예비능 개념", lessons: ["인지예비능이란", "인지훈련의 원리", "예방적 접근법"], duration: "3시간" },
      { title: "인지훈련 실습", lessons: ["주의력 훈련", "기억력 훈련", "실행기능 훈련"], duration: "4시간" },
      { title: "프로그램 운영 실무", lessons: ["개별 평가 방법", "그룹 운영 기법", "진행 매뉴얼"], duration: "4시간" },
      { title: "실습 및 평가", lessons: ["시뮬레이션 실습", "사례 발표", "필기평가"], duration: "4시간" },
    ],
